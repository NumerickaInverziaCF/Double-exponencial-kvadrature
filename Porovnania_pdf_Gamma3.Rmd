---
title: "Comparisons methods for numerical inversion CF - Gamma distribution 3"
...
Na obrázkoch môžeme vidieť histogramy odchýlok spomenutých metód pre prvé rozhranie $\alpha$ , $\beta$ z intervalu $[1, 100]$.
...
```{r warning=FALSE}
result <- simulations(100,x,1e-15,1,100)
```
