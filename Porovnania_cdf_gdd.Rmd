...
Na obrázkoch môžeme vidieť histogramy odchýlok spomenutých metód pre prvé rozhranie $\alpha$ , $\beta$ z intervalu $[1, 10]$.
```{r}
...
```{r warning=FALSE}
result <- simulations(100,1e-15,1,10)
```
