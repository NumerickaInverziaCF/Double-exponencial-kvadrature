---
title: "Porovnania PDF pre GDD 2"
...
Porovnávania algoritmu cf2DistGP s algoritmom cf2DistFFT a s algoritmami, ktoré okrem lichobežníkovej kvadratúry pri výpočte integrálov využívajú aj Dvojitú exponenciálnu kvadratúru.
...
Na obrázkoch môžeme vidieť histogramy odchýlok spomenutých metód pre druhé rozhranie $\alpha$ , $\beta$ z intervalu $[10, 50]$.
```{r}
